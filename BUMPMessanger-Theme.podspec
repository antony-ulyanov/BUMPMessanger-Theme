...
Pod::Spec.new do |s|
  ...
  s.resource_bundles = {
    'BUMPMessanger-Theme.Bump' => ['Pod/Assets/ThemeBump.bundle/**/*.png'],
    'BUMPMessanger-Theme.Mgimo' => ['Pod/Assets/ThemeMgimo.bundle/**/*.png'],
    'BUMPMessanger-Theme.Mipt' => ['Pod/Assets/ThemeMipt.bundle/**/*.png']    
  }  
end
