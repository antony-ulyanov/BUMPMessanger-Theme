...
Pod::Spec.new do |s|
  ...
  s.resource_bundles = {
    'BUMPMessanger-Theme.Bump' => ['Pod/Assets/Bump/ThemeBump.bundle/**/*.png'],
    'BUMPMessanger-Theme.Mgimo' => ['Pod/Assets/Mgimo/ThemeMgimo.bundle/**/*.png'],
    'BUMPMessanger-Theme.Mipt' => ['Pod/Assets/Mipt/ThemeMipt.bundle/**/*.png']    
  }  
end
